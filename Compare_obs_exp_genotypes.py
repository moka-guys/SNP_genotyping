'''
This script compares two gVCFS when etsted by different SNP genotyping assays, an 'observed' - in this case from a SNP genotyping assay and an 'expected' "truth" set.
...
samples2=[]
# define output files
output_file1='/home/aled/Documents/190619_Nimegen_SNP_part2/non_giab_results.txt'
output_file2='/home/aled/Documents/190619_Nimegen_SNP_part2/giab_results.txt'
output_file3='/home/aled/Documents/190619_Nimegen_SNP_part2/non_giab_coverage.txt'
output_file4='/home/aled/Documents/190619_Nimegen_SNP_part2/giab_coverage.txt'
...
for obs_file in os.listdir("/home/aled/Documents/190619_Nimegen_SNP_part2/observed/vcf_decomposed"):
    if obs_file.endswith(".vcf"):
        ...
        if "na" not in dna_num:
            ...
            for exp_file in os.listdir("/home/aled/Documents/190619_Nimegen_SNP_part2/expected/vcf_decomposed"):
                if exp_file.endswith(".vcf") and dna_num in exp_file:
                    ...
                    for gene in dict["variant"]:
                        ...
                        with open("/home/aled/Documents/190619_Nimegen_SNP_part2/observed/vcf_decomposed/" + obs_file,'r') as obs_vcf:
                        ...
                        found=False
                        # open expected vcf
                        with open("/home/aled/Documents/190619_Nimegen_SNP_part2/expected/vcf_decomposed/" + exp_file,'r') as exp_vcf:
        ...
        # repeat for na12878 samples 
            ...
            for exp_file in os.listdir("/home/aled/Documents/190619_Nimegen_SNP_part2/expected/vcf"):
                if exp_file.endswith(".vcf") and dna_num in exp_file:
